...
public class BlockMinesweeperDisplayEntityRenderer extends BaseGameBlockEntityRenderer<BlockMinesweeperDisplayEntity, BlockMinesweeperDisplayEntityRenderer.BlockMinesweeperDisplayEntityRenderState> {
    ...
    @Override
    public void extractRenderState(BlockMinesweeperDisplayEntity blockEntity, BlockMinesweeperDisplayEntityRenderState state, float partialTicks, @NonNull Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
