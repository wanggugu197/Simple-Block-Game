...
public class simpleMinesweeperRegistration {
    ...
    public static void init() {
        REGISTRY.addRecipeData(prov -> prov.shaped(RecipeCategory.COMBAT, BLOCK_MINESWEEPER_CORE)
                .pattern("QQQ")
                .pattern("QIQ")
                .pattern("QQQ")
    ...
    // minesweeper
    public static final BlockEntry<BlockMinesweeperCore> BLOCK_MINESWEEPER_CORE = REGISTRY
            .block(REGISTRY, "minesweeper_core", BlockMinesweeperCore::new)
            .langCn("扫雷核心方块")
    ...
    public static final BlockEntry<BlockMinesweeperDisplay> BLOCK_MINESWEEPER_DISPLAY = REGISTRY
            .block(REGISTRY, "minesweeper_display", BlockMinesweeperDisplay::new)
            .langCn("扫雷显示方块")
    ...
    public static final BlockEntry<BaseVerticalRefreshBlock> BLOCK_MINESWEEPER_REFRESH = REGISTRY
            .block(REGISTRY, "minesweeper_refresh", p -> BaseVerticalRefreshBlock.create(p, "minesweeper"))
            .langCn("扫雷控制方块")
    ...
    public static final BlockEntityTypeEntry<BlockMinesweeperCoreEntity> BLOCK_MINESWEEPER_CORE_ENTITY = REGISTRY
            .blockEntity(REGISTRY, "minesweeper_core_entity", (_, p, s) -> new BlockMinesweeperCoreEntity(p, s))
            .validBlock(BLOCK_MINESWEEPER_CORE)
            .renderer(() -> () -> BlockMinesweeperCoreEntityRenderer::new)
            .register();

    public static final BlockEntityTypeEntry<BlockMinesweeperDisplayEntity> BLOCK_MINESWEEPER_DISPLAY_ENTITY = REGISTRY
            .blockEntity(REGISTRY, "minesweeper_display_entity", (_, p, s) -> new BlockMinesweeperDisplayEntity(p, s))
