...
public class simpleJustGet10Registration {
    ...
    public static void init() {
        REGISTRYLIB.addRecipeData(prov -> prov.shaped(RecipeCategory.COMBAT, BLOCK_JUST_GET_10_CORE)
                .pattern("QQQ")
                .pattern("QIQ")
                .pattern("QQQ")
    ...
    public static final BlockEntry<BlockJustGet10Core> BLOCK_JUST_GET_10_CORE = REGISTRYLIB
            .block(REGISTRYLIB, "just_get_10_core", BlockJustGet10Core::new)
            .langCn("合成10核心方块")
    ...
    public static final BlockEntry<BlockJustGet10Display> BLOCK_JUST_GET_10_DISPLAY = REGISTRYLIB
            .block(REGISTRYLIB, "just_get_10_display", BlockJustGet10Display::new)
            .langCn("合成10显示方块")
    ...
    public static final BlockEntry<BaseRotatedRefreshBlock> BLOCK_JUST_GET_10_REFRESH = REGISTRYLIB
            .block(REGISTRYLIB, "just_get_10_refresh", p -> BaseRotatedRefreshBlock.create(p, "just_get_10"))
            .langCn("合成10控制方块")
    ...
    public static final BlockEntityTypeEntry<BlockJustGet10CoreEntity> BLOCK_JUST_GET_10_CORE_ENTITY = REGISTRYLIB
            .blockEntity(REGISTRYLIB, "just_get_10_core_entity", (_, p, s) -> new BlockJustGet10CoreEntity(p, s))
            .validBlock(BLOCK_JUST_GET_10_CORE)
            .renderer(() -> () -> BlockJustGet10CoreEntityRenderer::new)
            .register();

    public static final BlockEntityTypeEntry<BlockJustGet10DisplayEntity> BLOCK_JUST_GET_10_DISPLAY_ENTITY = REGISTRYLIB
            .blockEntity(REGISTRYLIB, "just_get_10_display_entity", (_, p, s) -> new BlockJustGet10DisplayEntity(p, s))
