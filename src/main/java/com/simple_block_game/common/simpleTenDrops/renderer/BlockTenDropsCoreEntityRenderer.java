...
public class BlockTenDropsCoreEntityRenderer extends SingleFaceBlockEntityRenderer<BlockTenDropsCoreEntity, BlockTenDropsCoreEntityRenderer.BlockTenDropsCoreEntityRenderState> {
    ...
    @Override
    public @NonNull BlockTenDropsCoreEntityRenderState createRenderState() {
        return new BlockTenDropsCoreEntityRenderState();
    }

    @Override
    public void extractRenderState(@NonNull BlockTenDropsCoreEntity blockEntity, @NonNull BlockTenDropsCoreEntityRenderState state, float partialTicks, @NonNull Vec3 cameraPosition, ModelFeatureRenderer.CrumblingOverlay breakProgress) {
