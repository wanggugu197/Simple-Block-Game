...
public class simpleMemoryKeyRegistration {
    ...
    public static void init() {
        REGISTRY.addRecipeData(prov -> prov.shaped(RecipeCategory.COMBAT, BLOCK_MEMORY_KEY_CORE)
                .pattern("QQQ")
                .pattern("QIQ")
                .pattern("QQQ")
    ...
    // memory key
    public static final BlockEntry<BlockMemoryKeyCore> BLOCK_MEMORY_KEY_CORE = REGISTRY
            .block(REGISTRY, "memory_key_core", BlockMemoryKeyCore::new)
            .langCn("记忆键核心方块")
    ...
    public static final BlockEntry<BlockMemoryKeyButton> BLOCK_MEMORY_KEY_BUTTON = REGISTRY
            .block(REGISTRY, "memory_key_button", BlockMemoryKeyButton::new)
            .langCn("记忆键按钮方块")
    ...
    public static final BlockEntry<BaseVerticalRefreshBlock> BLOCK_MEMORY_KEY_REFRESH = REGISTRY
            .block(REGISTRY, "memory_key_refresh", p -> BaseVerticalRefreshBlock.create(p, "memory_key"))
            .langCn("记忆键控制方块")
    ...
    public static final BlockEntityTypeEntry<BlockMemoryKeyCoreEntity> BLOCK_MEMORY_KEY_CORE_ENTITY = REGISTRY
            .blockEntity(REGISTRY, "memory_key_core_entity", (_, p, s) -> new BlockMemoryKeyCoreEntity(p, s))
            .validBlock(BLOCK_MEMORY_KEY_CORE)
            .renderer(() -> () -> BlockMemoryKeyCoreEntityRenderer::new)
            .register();

    public static final BlockEntityTypeEntry<BlockMemoryKeyButtonEntity> BLOCK_MEMORY_KEY_BUTTON_ENTITY = REGISTRY
            .blockEntity(REGISTRY, "memory_key_button_entity", (_, p, s) -> new BlockMemoryKeyButtonEntity(p, s))
