...
public class ClientModEvents {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerBlockEntityRenderer(
                (BlockEntityType<Block2048CoreEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_2048_CORE_ENTITY.get(),
                Block2048CoreEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<Block2048DisplayEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_2048_DISPLAY_ENTITY.get(),
                Block2048DisplayEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockMinesweeperCoreEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_MINESWEEPER_CORE_ENTITY.get(),
                BlockMinesweeperCoreEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockMinesweeperDisplayEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_MINESWEEPER_DISPLAY_ENTITY.get(),
                BlockMinesweeperDisplayEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockMemoryKeyCoreEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_MEMORY_KEY_CORE_ENTITY.get(),
                BlockMemoryKeyCoreEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockMemoryKeyButtonEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_MEMORY_KEY_BUTTON_ENTITY.get(),
                BlockMemoryKeyButtonEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockTenDropsCoreEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_TEN_DROPS_CORE_ENTITY.get(),
                BlockTenDropsCoreEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockTenDropsDisplayEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_TEN_DROPS_DISPLAY_ENTITY.get(),
                BlockTenDropsDisplayEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockSudokuCoreEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_SUDOKU_CORE_ENTITY.get(),
                BlockSudokuCoreEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<BlockSudokuDisplayEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_SUDOKU_DISPLAY_ENTITY.get(),
                BlockSudokuDisplayEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<Block24PuzzleCoreEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_24PUZZLE_CORE_ENTITY.get(),
                Block24PuzzleCoreEntityRenderer::new);
        event.registerBlockEntityRenderer(
                (BlockEntityType<Block24PuzzleDisplayEntity>) (BlockEntityType<?>) SimpleBlockGameRegistration.BLOCK_24PUZZLE_DISPLAY_ENTITY.get(),
